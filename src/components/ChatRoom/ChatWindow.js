...
const BottonGroupStyled = styled.div`
    display: flex;
    align-items: center;
`;
            ...
            {selectedRoom.id ? (
                <>
                    <HeaderStyled>
                        ...
                        <BottonGroupStyled>
                            <Button icon={<UserAddOutlined />} type="text" onClick={() => setIsInvite(true)}>
                                Mời
                            </Button>
                            ...
                            {messages?.map((mes, index) => {
                                return (
                                    <Message
                                        key={index}
                                        createdAt={
                                            mes?.createdAt ? (new Date(mes?.createdAt.seconds*1000)).toUTCString() : ''
                                        }
                                        text={mes?.text}
